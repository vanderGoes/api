...
//Teams
case class PartupsInsertedEvent(timestamp: String, creator_id: String, _id: String, name: String, tags: List, language: String, place_id: String, city: String, country: String, network_id: String, privacy_type: Int, activity_count: Int, progress: Int, type_partup: String, type_com_budget: Int, type_org_budget: Int, phase: String)
  extends Event(timestamp, "partups.inserted")

case class PartupsUpdatedEvent(timestamp: String, _id: String, name: String, tags: List, language: String, place_id: String, city: String, country: String, privacy_type: Int, activity_count: Int, progress: Int, type_partup: String, type_com_budget: Int, type_org_budget: Int, phase: String)
  extends Event(timestamp, "partups.updated")

case class PartupsChangedEvent(timestamp: String, _id: String, name: String, tags: List, language: String, place_id: String, city: String, country: String, privacy_type: Int, activity_count: Int, progress: Int, type_partup: String, type_com_budget: Int, type_org_budget: Int, phase: String)
...
//Users
case class UsersInsertedEvent(timestamp: String, _id: String, name: String, place_id: String, city: String, country: String, tags: List)
  extends Event(timestamp, "users.inserted")

case class UsersUpdatedEvent(timestamp: String, _id: String, name: String, place_id: String, city: String, country: String, tags: List)
  extends Event(timestamp, "users.updated")

case class UsersChangedEvent(timestamp: String, _id: String, name: String, place_id: String, city: String, country: String, tags: List)
