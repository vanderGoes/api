...
//NODES
//Users
case class UsersInsertedEvent(timestamp: String, _id: String, language: String, deactivatedAt: String, place_id: String, city: String, country: String, tags: List[String], code_0: Int, name_0: String, score_0: Int, code_1: Int, name_1: String, score_1: Int)
  extends Event(timestamp, "users.inserted")

case class UsersUpdatedEvent(timestamp: String, _id: String, language: String, deactivatedAt: String, place_id: String, city: String, country: String, tags: List[String], code_0: Int, name_0: String, score_0: Int, code_1: Int, name_1: String, score_1: Int)
  extends Event(timestamp, "users.updated")

case class UsersChangedEvent(timestamp: String, _id: String, language: String, deactivatedAt: String, place_id: String, city: String, country: String, tags: List[String], code_0: Int, name_0: String, score_0: Int, code_1: Int, name_1: String, score_1: Int)
...
//Teams
case class PartupsInsertedEvent(timestamp: String, creator_id: String, _id: String, name: String, tags: List[String], language: String, place_id: String, city: String, country: String, network_id: String, privacy_type: Int, type_partup: String, phase: String, activity_count: Int, end_date: String, deactivatedAt: String)
  extends Event(timestamp, "partups.inserted")

case class PartupsUpdatedEvent(timestamp: String, _id: String, name: String, tags: List[String], language: String, place_id: String, city: String, country: String, privacy_type: Int, type_partup: String, phase: String, activity_count: Int, end_date: String, deactivatedAt: String)
  extends Event(timestamp, "partups.updated")

case class PartupsChangedEvent(timestamp: String, _id: String, name: String, tags: List[String], language: String, place_id: String, city: String, country: String, privacy_type: Int, type_partup: String, phase: String, activity_count: Int, end_date: String, deactivatedAt: String)
